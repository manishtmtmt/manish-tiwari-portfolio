...
const greeting = {
  ...
  title: "Hi all, I'm Manish Tiwari",
  subTitle: emoji(
  ...
  schools: [
    {
      ...
      logo: require('./assets/images/masaiSchoolLogo.png'),
      subHeader: "Full Stack Web Development",
      duration: "January 2022 - October 2022",
    },
    {
      schoolName: "A S V M Inter College",
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Associate Software Development Engineer (SDE)",
      company: "Actyv.ai",
      companylogo: require("./assets/images/actyvLogo.png"),
      date: "November 2022 – Present",
      desc: "During my time at Actyv.ai, I played a pivotal role in our microservice ecosystem, contributing to various mission-critical projects:",
      descBullets: [
...
const twitterDetails = {
  userName: "twitter.com/manisht_mt", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
